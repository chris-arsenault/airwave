...
mod content_directory_scpd {
    ...
    fn xml() -> &'static str {
        wiim_dlna::upnp::xml::content_directory_scpd()
    }
...
mod connection_manager_scpd {
    ...
    fn xml() -> &'static str {
        wiim_dlna::upnp::xml::connection_manager_scpd()
    }
...
mod soap_envelope {
    ...
    fn response_is_valid_xml() {
        let s = wiim_dlna::upnp::soap::soap_response(
    ...
    fn fault_is_valid_xml() {
        let s = wiim_dlna::upnp::soap::soap_fault("s:Client", "UPnPError", 401, "Invalid Action");
        parse_xml(&s);
    }

    #[test]
    fn fault_has_correct_structure() {
        let s = wiim_dlna::upnp::soap::soap_fault("s:Client", "UPnPError", 701, "No such object");
        let doc = parse_xml(&s);
  ...
  <s:Body>
    <u:Browse xmlns:u="urn:schemas-upnp-org:service:ContentDirectory:1">
      ...
      <SortCriteria></SortCriteria>
        ...
        let action = wiim_dlna::upnp::soap::parse_soap_action(
...
mod didl_lite {
    ...
    use wiim_dlna::media::library::{Container, Track};
    use wiim_dlna::media::metadata::TrackMetadata;
    use wiim_dlna::upnp::didl::DidlWriter;
