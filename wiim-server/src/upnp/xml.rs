...
/// Generate the root device description XML (device.xml).
pub fn device_description(uuid: &str, friendly_name: &str, base_url: &str) -> String {
    format!(
...
/// ContentDirectory:1 SCPD (service description).
